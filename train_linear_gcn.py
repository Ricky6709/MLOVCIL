...
@torch.no_grad()
def test_model(ram_model, cla_model, cla_img_model, cla_gcn_model, text_model, test_loader, imglist,  taglist, label_embed_clip, topk):
    ram_model.eval()
    text_model.eval()
    cla_model.eval()
    cla_img_model.eval()
...
if __name__ == "__main__":
    ...
    output_dir_1 = args.output_dir + "/" + "coco_task1" + "/" + "Train_with_full_labels_test_median_loss"
